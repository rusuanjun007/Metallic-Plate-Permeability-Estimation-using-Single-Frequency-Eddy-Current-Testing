...
class BlockV1(hk.Module):
    ...
    def __init__(
        self,
        channels: int,
        stride: Union[Tuple, Sequence[Tuple]],
        use_projection: bool,
        ...
        conv_0 = hk.Conv2D(
            ...
            kernel_shape=(1, 1) if bottleneck else (3, 1),
            stride=(1, 1) if bottleneck else stride,
            with_bias=False,
            padding="SAME",
            name="conv_0",
        )
        ...
        conv_1 = hk.Conv2D(
            output_channels=channels // channel_div,
            kernel_shape=(3, 1),
            stride=stride if bottleneck else (1, 1),
            with_bias=False,
            padding="SAME",
            name="conv_1",
        )
...
class ResNet(hk.Module):
    ...
    def __init__(
        ...
        strides: Sequence[Tuple] = ((1, 1), (2, 1), (2, 1), (2, 1)),
    ):
        ...
        # This will cause 0 grad begore multi-head.
        ...
        initial_conv_config.setdefault("kernel_shape", (7, 1))
        initial_conv_config.setdefault("stride", (2, 1))
    ...
    def __call__(self, inputs, is_training, test_local_stats=False):
        ...
        out = hk.max_pool(
            out, window_shape=(1, 3, 1, 1), strides=(1, 2, 1, 1), padding="SAME"
        )
